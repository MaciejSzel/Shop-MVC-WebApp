        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RodzajImagePath = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdPodkategorii = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nazwa = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    Opis = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Podkategoria", x => x.IdPodkategorii);
                    table.ForeignKey(
                        name: "FK_Podkategoria_Rodzaj_RodzajId",
                        column: x => x.RodzajId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Podkategoria_PodkategoriaId",
                        column: x => x.PodkategoriaId,
                        principalTable: "Podkategoria",
                        principalColumn: "IdPodkategorii",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Podkategoria_RodzajId",
                table: "Podkategoria",
                column: "RodzajId");

            migrationBuilder.CreateIndex(
                name: "IX_Products_PodkategoriaId",
                table: "Products",
